package com.shoppinglist3.shoppinglist2.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable) // CSRF 보호 비활성화(Stateless JWT 사용)
                ...
                .sessionManagement(session ->
                        session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // 세션 비활성화 sessionCreationPolicy
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint(authEntryPoint))  // 인증 실패
...
//                        authorizeHttpRequests.anyRequest().permitAll());
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(Arrays.asList("*"));    // 모든 헤더 적용
